...
HandCricket.Tile = function (state, type, x, y) {
    this.id = type.id;
    this._x = x;
    this._y = y;
    this.state = state;
...
HandCricket.Tile.prototype = Object.create(Phaser.Group.prototype);
HandCricket.Tile.prototype.constructor = HandCricket.Tile;

HandCricket.Tile.prototype.setHighlight = function (highlight) {
    if (highlight) {
...
HandCricket.Tile.prototype.destroy = function () {
...
HandCricket.Tile.prototype.relocate = function (x, y) {
